...
public class SousFenetreVersement extends JInternalFrame implements InternalFrameListener, ActionListener
{
    ...
    public SousFenetreVersement(String s,Vector<Versement> listeVersement,Vector<Colonne> listeColonnes, JDesktopPane p)
    {
...
// --------------------------------------------------------------------------
        modeleTable = new ModeleTableVersement(listeVersement, listeColonnes);
...
// --------------------------------------------------------------------------
    ...
    {
        Controleur.arretV(modeleTable.getListeVersement(),
                modeleTable.getListeVersement('M'),
                modeleTable.getListeVersement('I'));
    }
