...
// --------------------------------------------------------------------------
    public static void demandeContacts() throws ClassNotFoundException, IOException {
...
// --------------------------------------------------------------------------
    public static void majContacts(Vector<Contact> contactsInseres,
            ...
            Vector<Contact> contactsSupprimes) throws ClassNotFoundException, IOException {
        Contact contact;
        int i;
