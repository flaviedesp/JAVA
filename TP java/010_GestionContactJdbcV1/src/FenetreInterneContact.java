...
// ==========================================================================
    public FenetreInterneContact(Vector<Contact> listeContacts,
                                 ...
                                 Vector<Secteur> listeSecteur) throws SQLException
    {
...
// --------------------------------------------------------------------------
        ...
        {
            combo.addItem(listeSecteur.elementAt(i).getCode());
        }
    ...
    private class EcouteInternalFrameClosing extends InternalFrameAdapter
    {
        ...
        public void internalFrameClosing(InternalFrameEvent e)
        {
            try {
                ...
                Logger.getLogger(FenetreInterneContact.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}