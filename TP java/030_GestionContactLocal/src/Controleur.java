...
// --------------------------------------------------------------------------
    public static void demandeContacts() {
        ...
        try {
            ...
            base = new BaseDeDonnees("jdbc:sqlserver://mars;databasename=gnmi;" + "user=util_bip;password=x");
            accesBase = new AccesBase(base);
            try {
                accesBase.getConnection();
                try {
                    listeContacts = contactDAO.creeListeContacts(accesBase);
                ...
                maFenetre.afficheMessage("Impossible d'ouvrir la base de données'gnmi' demandée par la connexion. La connexion a échouée");

            }
        } catch (ClassNotFoundException e) {
            System.out.println("Impossible d'ouvrir la base de données'gnmi' demandée par la connexion. La connexion a échouée");
        }
    }
